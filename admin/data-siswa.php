            ...
            <table class="table table-bordered" id="tabelsiswa">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <img src="Uploads/<?= strtolower($row['foto']) ?>" alt="foto" class="foto">
                  </td>
                  <td>
                    <button class="btn btn-sm btn-view me-1" data-id="<?= $row['id'] ?>"><i class="fas fa-eye"></i></button>
                    <a href="siswa_edit.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning me-1"><i class="fas fa-edit"></i></a>
                    <button class="btn btn-sm btn-danger btn-hapus me-1" data-id="<?= $row['id'] ?>"><i class="fas fa-trash"></i></button>
